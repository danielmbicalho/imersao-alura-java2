    ...
    public class App {
        ...
        public static void main(String[] args) throws Exception {
            ...
            // Conversor de código https://www.fileformat.info/info/unicode/char/search.htm
            String starEmoji = "\u2B50";
            ...
            // String topTVsURL = "https://imdb-api.com/en/API/Top250TVs/" + imdbKey;
            ...
            // for (String endpoint : endpoints) {
                ...
                for (Map<String,String> filme : listaDeFilmes) {
                    ...
                    if (rateInt >= 8){
                        System.out.print(grinningFaceEmoji);
                    }else if (rateInt < 8 && rateInt >= 6 ){
                        System.out.print(smileFaceEmoji);   
                    }else if (rateInt < 6 && rateInt >= 5 ){
                        System.out.print(neutralFaceEmoji);   
                    }else if (rateInt < 5 && rateInt >= 4 ){
                        System.out.print(neutralFaceEmoji);
                    }else if (rateInt < 4 && rateInt >= 3 ){
                        System.out.print(disapointedFaceEmoji);
                    }
                    else{
                        System.out.print(sleepyFaceEmoji);   
                    }
